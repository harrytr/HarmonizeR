...
Clone this Repo locally. Load the Shiny App by running the Harmonizer.R from Rstudio. You will need R.4.5.0 and Python 3.11.7 (tested and working ; anything more recent might not work). 
